...
public class WinPage {
    ...
    public static void print(Terminal terminal) {
        terminal.writer().print(ansi().cursor((terminal.getHeight() - 9) / 2, (terminal.getWidth() - 65) / 2));
    ...
    private static Ansi print() {
        ...
        ansi.a(printTitle());
        ansi.a(moveCursor(WinOptions.getInstance()));
        ansi.a(printOptions());
        return ansi;
    }
    ...
    private static Ansi newLine() {
        return Utilities.moveCursor(WinNewLine.getInstance());
    }
}
