...
public class Server {
     ...
     */
    private List<Player> parsePlayersList(JsonArray json, Map<String, Player> players) {
     ...
     * @return The List that has been built.
     */
    private List<Assistant> parseAssistants(JsonArray json) {
     ...
     */
    private SchoolBoard parseSchoolBoard(JsonObject json) {
     ...
     */
    private GameBoard parseGameBoard(JsonObject json, boolean expert, Map<String, Player> players) {
     ...
     */
    private Map<Player, Assistant> parsePlayedAssistants(JsonArray json, Map<String, Player> players) {
     ...
     * @return The List that has been built.
     */
    private List<Island> parseIslands(JsonArray json) {
     ...
     * @return The List that has been built.
     */
    private List<Cloud> parseClouds(JsonArray json) {
     ...
     * @return The List that has been built.
     */
    private List<SpecialCharacter> parseSpecialCharacters(JsonArray json) {
     ...
     * @return The Map that has been built.
     */
    private Map<HouseColor, Integer> parseHouseColorIntMap(JsonObject json) {
